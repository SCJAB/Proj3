...
<body>
    ...
    <div class="grid grid-cols-1 mt-10 mx-10 gap-y-10 justify-items-center md:grid-cols-2 lg:grid-cols-3 lg:gap-x-12">
        <div class="rounded-2xl bg-red-950 h-[100%] w-full relative shadow-xl md:h-96 md:w-80 lg:w-full hover:ring-4 hover:ring-red-400 hover:bg-red-400">
            ...
            <div>
                <a href="#" class="show-modal md:mx-32 py-2 text-white text-xs flex justify-center hover:bg-red-950 rounded-3xl" data-modal="1">View Recipe</a>
            </div>
        </div>
